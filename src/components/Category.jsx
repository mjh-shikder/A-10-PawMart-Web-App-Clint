...
const Category = () => {
  ...
  return (
    <div data-aos="fade-right">
      ...
      <div className="bg-base-100 mt-10 rounded-xl px-9 py-0.5">
        <Swiper
          spaceBetween={20}
          slidesPerView={5}
          modules={[Autoplay]}
              ...
              <div className="relative w-full h-full">
                ...
                <div className="relative z-10 flex h-full items-center  md:items-center md:justify-start md:pb-0">
                  <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 text-center">
                    <h2 className=" text-center text-4xl md:text-2xl lg:text-3xl font-bold text-white drop-shadow-lg ">
                      Free Pet Adoption
                    </h2>
                  </div>
                </div>
          ...
          <SwiperSlide className="rounded-2xl ">
            <Link>
              <div className="relative w-full h-full">
                ...
                <div className="relative z-10 flex h-full items-center  md:items-center md:justify-start md:pb-0">
                  <div className="max-w-7xl text-center mx-auto px-6 md:px-12 lg:px-16">
                    <h2 className="text-4xl text-center md:text-2xl lg:text-3xl font-bold text-white drop-shadow-lg ">
                      Nutritious bites
                    </h2>
                  </div>
                </div>
